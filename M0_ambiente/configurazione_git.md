...
# output ottenuto
file:/etc/gitconfig     user.name=gioelelumia
file:/etc/gitconfig     user.email=gioele.lumia@marconirovereto.it
...
file:.git/config        remote.origin.url=https://github.com/gioelelumia/Informatica-Python-Lumia-Gioele-4Bi
:
